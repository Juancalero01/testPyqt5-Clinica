...
class Ui_ModificarPaciente(object):
    def setupUi(self, ModificarPaciente):
        ModificarPaciente.setObjectName("ModificarPaciente")
        ModificarPaciente.resize(350, 450)
        ModificarPaciente.setMinimumSize(QtCore.QSize(350, 450))
        ModificarPaciente.setMaximumSize(QtCore.QSize(350, 450))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Views/Icons/iconPrincipal.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ModificarPaciente.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(ModificarPaciente)
        ...
        self.txtDocumentoPaciente.setReadOnly(True)
        ...
        self.btnActualizarPaciente = QtWidgets.QPushButton(self.centralwidget)
        self.btnActualizarPaciente.setGeometry(QtCore.QRect(220, 370, 100, 50))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        self.btnActualizarPaciente.setFont(font)
        self.btnActualizarPaciente.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnActualizarPaciente.setStyleSheet("QPushButton{\n"
                                                 "background: #0090D9;\n"
                                                 "border:none;\n"
                                                 "border-radius: 5px;\n"
                                                 "color: #fff;\n"
                                                 ...
                                                 "}\n"
                                                 "")
        self.btnActualizarPaciente.setObjectName("btnActualizarPaciente")
        ...
        ModificarPaciente.setCentralWidget(self.centralwidget)

        self.retranslateUi(ModificarPaciente)
        QtCore.QMetaObject.connectSlotsByName(ModificarPaciente)

    def retranslateUi(self, ModificarPaciente):
        _translate = QtCore.QCoreApplication.translate
        ModificarPaciente.setWindowTitle(_translate(
            "ModificarPaciente", "Modificar Paciente"))
        self.txtNombrePaciente.setPlaceholderText(
            _translate("ModificarPaciente", " INGRESE EL NOMBRE"))
        self.txtApellidoPaciente.setPlaceholderText(
            _translate("ModificarPaciente", " INGRESE EL APELLIDO"))
        self.txtDocumentoPaciente.setPlaceholderText(_translate(
            "ModificarPaciente", " INGRESE EL NUMERO DE DOCUMENTO"))
        self.datePaciente.setDisplayFormat(
            _translate("ModificarPaciente", "yyyy/MM/dd"))
        self.btnActualizarPaciente.setText(
            _translate("ModificarPaciente", "ACTUALIZAR"))
        self.btnCancelarPaciente.setText(
            _translate("ModificarPaciente", "CANCELAR"))
        self.cmbPaciente.setPlaceholderText(
            _translate("ModificarPaciente", "Seleccione"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ModificarPaciente = QtWidgets.QMainWindow()
    ui = Ui_ModificarPaciente()
    ui.setupUi(ModificarPaciente)
